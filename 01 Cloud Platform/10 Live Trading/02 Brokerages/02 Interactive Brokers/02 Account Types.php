...
<h4>FA Accounts</h4>
<p>IB supports FA accounts for Trading Firm and Institution organizations. FA accounts enable certified professionals to use a single trading algorithm to manage several client accounts. The integration must recognize the connected account as an FA master account to enable its FA services. For group routing, account snapshots, configuration, and supported management operations, see <a href="/docs/v2/writing-algorithms/trading-and-orders/financial-advisors">Financial Advisors</a>.</p>
